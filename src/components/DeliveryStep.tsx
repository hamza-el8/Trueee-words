        ...
        {((form.deliveryFormat === "email" || form.deliveryFormat === "pdf") || form.deliverySpeed === "scheduled") && (
          <div className="mt-8 animate-fade-in bg-secondary/20 p-6 rounded-xl border border-border">
            ...
            <p className="text-[13px] text-muted-foreground mb-4">
              {(form.deliveryFormat === "email" || form.deliveryFormat === "pdf") && form.deliverySpeed !== "scheduled" && "Please provide the email of the person who will receive the letter."}
              {form.deliverySpeed === "scheduled" && (form.deliveryFormat !== "email" && form.deliveryFormat !== "pdf") && "Please provide the exact date and time for delivery."}
              {(form.deliveryFormat === "email" || form.deliveryFormat === "pdf") && form.deliverySpeed === "scheduled" && "Please provide the recipient's email as well as the delivery date and time."}
            </p>
